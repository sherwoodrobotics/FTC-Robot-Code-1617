...
@Autonomous(name="Blue - Full Auto", group="SHS")
...
public class FullAutoBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Wait(1);
        gyroDrive2(DRIVE_SPEED, -45.0, -45.0);
        gyroTurn(TURN_SPEED, 0);
       // gyroDriveToWhiteLine(DRIVE_SPEED, -50.0, 0.0, colorSensorGroundFront);
        beacon();
        //gyroDriveToWhiteLine(DRIVE_SPEED, -10.0, 0.0, colorSensorGroundBack);
        beacon();
